...
6. [Missing Media Reference — Tham chiếu phương tiện bị thiếu]:
   - Đề bài yêu cầu dựa vào Hình ảnh, Sơ đồ, hoặc Bảng (Ví dụ: "Dựa vào hình vẽ bên", "Quan sát sơ đồ sau", "Theo bảng số liệu...") nhưng trong nội dung thẻ KHÔNG hề có bất kỳ hình ảnh (thẻ <img>) hay cấu trúc bảng nào.
   - Đây là lỗi phổ biến khi copy-paste thiếu dữ liệu.

7. [Gibberish / Corrupt — Nội dung hỏng]:
...
# 5. Giới hạn số lượng thẻ xử lý mỗi lần chạy (None = không giới hạn)
